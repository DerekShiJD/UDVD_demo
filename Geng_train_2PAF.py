...
def main(args):
    ...
    for epoch in range(start_epoch, args.num_epochs):
        ...
        for batch_id, inputs in enumerate(train_bar):
            ...
            #print('!!!2', noisy_frame.shape)
            #print('!!!3', noisy_inputs.shape)
            #print('!!!4', noisy_inputs.shape)
            #print('!!!1', out.shape)
            #print('!!!1', out)
...
def get_args():
    ...
    # Add data arguments
    parser.add_argument("--data-path", default="/home/jindous2/DerekDatasets/BIL/Geng_SLAM2/For_uDVD_new/2PAF", help="path to data directory")
    ...
    parser.add_argument("--num-epochs", default=30, type=int, help="force stop training at specified epoch")
